...
namespace TrexRunner.Entities
{
    ...
    {
        private const float GROUNDTILE_POS_Y = 119;
        ...
        {
            GroundTile groundTile = new GroundTile(positionX, GROUNDTILE_POS_Y, _regularSprite);
            return groundTile;
        }

        private GroundTile CreateBumpyTile(float positionX)
        {
            GroundTile groundTile = new GroundTile(positionX, GROUNDTILE_POS_Y, _bumpySprite);
            return groundTile;
        }
